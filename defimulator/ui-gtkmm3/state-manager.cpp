#include <ui/state-manager.h>

StateManager stateManager;

void StateManager::create(void)
{
    ...
    stateList.create(*this, x, y, 500, 250, "Slot\tDescription");
    y += 255;
    ...
    loadButton.create(*this, x + 505 - 85 - 85 - 85, y, 80,
        Style::ButtonHeight, "Load");
    saveButton.create(*this, x + 505 - 85 - 85, y, 80,
        Style::ButtonHeight, "Save");
    eraseButton.create(*this, x + 505 - 85, y, 80,
        Style::ButtonHeight, "Erase");
...
void StateManager::synchronize(void)
{
    descEdit.setText("");
...
void StateManager::refresh(void)
{
...
void StateManager::slotLoad(void)
{
    if (auto position = stateList.selection()) {
...
void StateManager::slotSave(void)
{
    if (auto position = stateList.selection()) {
...
void StateManager::slotErase(void)
{
    if (auto position = stateList.selection()) {
