...
enum XScancode {
    ...
    Period, Slash, Keypad1, Keypad2, Keypad3, Keypad4, Keypad5, Keypad6,
    Keypad7, Keypad8, Keypad9, Keypad0, Point, Enter, Add, Subtract, Multiply,
    Divide, Up, Down, Left, Right,
...
void x_poll(int16_t *table)
{
    ...
    #define pressed(id) (bool)(state[scancode[id] >> 3] &\
        (1 << (scancode[id] & 7)))
