    ...
    while (true) {
        ...
        if (vcounter() == (!overscan() ? 225 : 240)) {
            if (regs.display_disabled == false) {
                ...
                regs.oam_firstsprite = (regs.oam_priority == false) ? 0 :
                    (regs.oam_addr >> 2) & 127;
            }
        }
...
void PPU::power(void)
{
    ...
    /* TODO: will a memset(..) work for this? */
    for (unsigned i = 0; i < memory::vram.size(); i++) {
        memory::vram[i] = 0x00;
    }

    for (unsigned i = 0; i < memory::oam.size(); i++) {
        memory::oam[i] = 0x00;
    }
...
void PPU::layer_enable(unsigned layer, unsigned priority, bool enable)
{
    ...
    case 0:
        layer_enabled[BG1][0] = enable;
        break;
    case 1:
        layer_enabled[BG1][1] = enable;
        break;
    case 4:
        layer_enabled[BG2][0] = enable;
        break;
    case 5:
        layer_enabled[BG2][1] = enable;
        break;
    case 8:
        layer_enabled[BG3][0] = enable;
        break;
    case 9:
        layer_enabled[BG3][1] = enable;
        break;
    case 12:
        layer_enabled[BG4][0] = enable;
        break;
    case 13:
        layer_enabled[BG4][1] = enable;
        break;
    case 16:
        layer_enabled[OAM][0] = enable;
        break;
    case 17:
        layer_enabled[OAM][1] = enable;
        break;
    case 18:
        layer_enabled[OAM][2] = enable;
        break;
    case 19:
        layer_enabled[OAM][3] = enable;
        break;
    }
}
