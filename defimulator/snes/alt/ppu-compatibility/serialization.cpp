...
void PPU::serialize(serializer &s)
{
    ...
    for (unsigned n = 0; n < 4; n++) {
        s.integer(regs.mosaic_enabled[n]);
    }
    s.integer(regs.mosaic_countdown);

    for (unsigned n = 0; n < 4; n++) {
        s.integer(regs.bg_scaddr[n]);
    }
    for (unsigned n = 0; n < 4; n++) {
        s.integer(regs.bg_scsize[n]);
    }

    for (unsigned n = 0; n < 4; n++) {
        s.integer(regs.bg_tdaddr[n]);
    }
    ...
    for (unsigned n = 0; n < 4; n++) {
        s.integer(regs.bg_hofs[n]);
    }
    for (unsigned n = 0; n < 4; n++) {
        s.integer(regs.bg_vofs[n]);
    }
    ...
    for (unsigned n = 0; n < 6; n++) {
        s.integer(regs.window1_enabled[n]);
    }
    for (unsigned n = 0; n < 6; n++) {
        s.integer(regs.window1_invert [n]);
    }
    for (unsigned n = 0; n < 6; n++) {
        s.integer(regs.window2_enabled[n]);
    }
    for (unsigned n = 0; n < 6; n++) {
        s.integer(regs.window2_invert [n]);
    }
    ...
    for (unsigned n = 0; n < 6; n++) {
        s.integer(regs.window_mask[n]);
    }
    for (unsigned n = 0; n < 5; n++) {
        s.integer(regs.bg_enabled[n]);
    }
    for (unsigned n = 0; n < 5; n++) {
        s.integer(regs.bgsub_enabled[n]);
    }
    for (unsigned n = 0; n < 5; n++) {
        s.integer(regs.window_enabled[n]);
    }
    for (unsigned n = 0; n < 5; n++) {
        s.integer(regs.sub_window_enabled[n]);
    }
    ...
    for (unsigned n = 0; n < 6; n++) {
        s.integer(regs.color_enabled[n]);
    }
    ...
    /*
    * better to just take a small speed hit than 
    * to store all of bg_tiledata[3][]...
    */
