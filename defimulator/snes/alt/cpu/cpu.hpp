...
public:
    ...
    alwaysinline void synchronize_smp(void);
    void synchronize_ppu(void);
    void synchronize_coprocessor(void);
...
private:
    ...
    debugvirtual void op_step(void);
    ...
    void last_cycle(void);
    void add_clocks(unsigned clocks);
    void scanline(void);
    void run_auto_joypad_poll(void);
