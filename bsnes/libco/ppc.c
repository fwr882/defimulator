...
cothread_t co_create(unsigned int size, void (*entry_)( void ))
{
    ...
    if (t) {
        ...
        /*
        * Save current registers into new thread, so that any special
        * ones will have proper values when thread is begun.
        */
        CO_SWAP_ASM(t, t);
        ...
        */
        ...
        /*
        * If uintptr_t is 32 bits, >>32 is undefined behavior, so we do
        * two shifts and dont' have to care how many bits uintptr_t is.
        */
        #if LIBCO_PPC64
        shift = 16;
        #else
