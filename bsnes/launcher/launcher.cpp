...
int main(int argc, char **argv)
{
    ...
    if(!CreateProcessW(nall::utf16_t(fileName), GetCommandLineW(),
        NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi)) {
        MessageBoxA(0, string("Error: unable to locate binary file: ",
            binaryName), "bsnes", MB_OK);
    }
    #endif
