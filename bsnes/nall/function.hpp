...
template<typename R, typename... P> class function<R (P...)> {
    ...
    template<typename C> struct member : container {
        ...
        R operator()(P... p) const
            { return (object->*function)(std::forward<P>(p)...); }
        container* copy() const { return new member(function, object); }
        member(R (C::*function)(P...), C *object) :
...
public:
    ...
    function() : callback(0) {}
    function(void *function) : callback(0)
        { if(function) callback = new global((R (*)(P...))function); }
    function(R (*function)(P...)) { callback = new global(function); }
    template<typename C> function(R (C::*function)(P...), C *object)
        { callback = new member<C>(function, object); }
    template<typename C> function(R (C::*function)(P...) const, C *object) 
        { callback = new member<C>((R (C::*)(P...))function, object); }
    template<typename L> function(const L& object)
        { callback = new lambda<L>(object); }
    ~function(void) { if(callback) delete callback; }
};
